...
答:
     ...
     Enter a integer to find the square of: 60
     3600
```
...
```
答:
How much does a chocolate bar cost? 56
...
How much does a chocolate bar cost? 46
Are you hungry(yes or no)? yes
...
```
答:
please pick a number: 55
Odd Number

please pick a number: 22
Even Number
```
